...
function MyFamily() {
    ...
    const [family_type, setFamily_type] = ["ancestors"]
    ...
    const fetchFamilyData = async () => {
        try {
            const response = await axios.get(`${api}/api/myfamily?is_ancestors=1`, {
                headers: {
                        ...
                        <div className="profile-content">
                                        ...
                                        <>
                                            {
                                                familyData && familyData
                                                    // .filter(item => item.family_type === 'ancestors')
                                                    .map((item, index) => {
                                                        // console.log(item)
                                                        return (
                                                            <div className='profile-information-box'>
                                                                    ...
                                                                    <Grid container spacing={2}>
                                                                        <Grid item xs={12} sm={12} md={6} lg={4} xl={4}>
                                                                            <div className='relation'>
                                                                                <h5>Relation</h5>
                                                                                <p>{item.relation && item.relation.name}</p>
                                                                            </div>
                                                                        </Grid>
                                                                        <Grid item xs={12} sm={12} md={6} lg={4} xl={4}>
                                                                            <div className='relation'>
                          ...
                          <MenuItem value={"Not Sure "}>Not Sure</MenuItem>
                                            ...
                                            <div className='myfamily-forms-btn'>
                                               ...
                                               <Button onClick={() => {handleSaveProfile(); toggleForm()}}>Save Profile</Button>
                                            </div>
                                        </div>
                                    </div>
                                )}
