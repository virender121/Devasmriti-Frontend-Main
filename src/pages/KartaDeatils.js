...
function MyFamily() {
    ...
    const [family_type, setFamily_type] = useState("Kartha")
    ...
    const fetchFamilyData = async () => {
        try {
            const response = await axios.get(`${api}/api/myfamily?is_kartha=1`, {
                headers: {
                                        ...
                                        <>
                                            {
                                                familyData && familyData
                                                    // .filter(item => item.family_type === 'kartha')
                                                    .map((item, index) => {
                                                        // console.log(item)
                                                        return (
                                                            <div className='profile-information-box'>
