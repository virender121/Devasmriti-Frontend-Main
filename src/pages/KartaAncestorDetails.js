...
function MyFamily() {
    ...
    const [family_type, setFamily_type] = useState("KarthaAncestor")
    ...
    const handleSaveEditedData = async () => {
        ...
        //     toast.error("Please enter a DOB");
        //     return;
        // }
        if (!editedData.relationId) {
            toast.error("Please select a Relation");
            return;
        }
        if (!editedData.rasiId) {
            toast.error("Please select a Rasi");
            return;
        }
        if (!editedData.gotram) {
            toast.error("Please enter a Gotram");
            return;
        }
        if (!editedData.nakshatram) {
            toast.error("Please select a Nakshatram");
            return;
        }
                                                        ...
                                                        <div className='profile-information-box'>
                                                            <div className="personal-information">
                                                                ...
                                                                <div className="edit-btn">
                                                                    <Button onClick={() => handleDeleteFamilyMember(item.id)}>Delete</Button>
